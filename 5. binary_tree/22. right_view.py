...
class Tree:
    ...
    def print_right(self, root, max_level, level):
        if root:
            if level > max_level[0]:
                print(root.data, end=" ")
                max_level[0] = level
            self.print_right(root.right, max_level, level+1)
            self.print_right(root.left, max_level, level+1)

    def right_view(self):
        max_level = [0]
        self.print_right(self.root, max_level, 1)
